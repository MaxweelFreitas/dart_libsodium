...
class PessoaObjectBuilder extends fb.ObjectBuilder {
  ...
  PessoaObjectBuilder({String? nome, int? idade})
    : _nome = nome,
      _idade = idade;
...
class PessoasWrapper {
  ...
  List<Pessoa>? get pessoas => const fb.ListReader<Pessoa>(
    Pessoa.reader,
...
class PessoasWrapperObjectBuilder extends fb.ObjectBuilder {
  ...
  PessoasWrapperObjectBuilder({List<PessoaObjectBuilder>? pessoas})
    : _pessoas = pessoas;

  /// Finish building, and store into the [fbBuilder].
  @override
  int finish(fb.Builder fbBuilder) {
    final int? pessoasOffset =
        _pessoas == null
            ? null
            : fbBuilder.writeList(
