...
Uint8List buildFlatBuffer({
  ...
  if (debug) {
    print(
      '${XTermColor.main}[FlatBuffer] Initializing builder with $initialSize bytes...',
    );
  }
  ...
  if (validate && offset <= 0) {
    throw Exception('${XTermColor.main}[FlatBuffer] Invalid offset: $offset');
  }
  ...
  if (debug) {
    print(
      '${XTermColor.main}[FlatBuffer] Buffer finalized with offset: $offset',
    );
    print(
      '${XTermColor.main}[FlatBuffer] Final buffer size: ${builder.buffer.lengthInBytes} bytes',
    );
  }
...
T readFlatBuffer<T>(
  ...
  if (debug) {
    print(
      '${XTermColor.main}[FlatBuffer] Reading buffer with ${buffer.length} bytes...',
    );
  }
